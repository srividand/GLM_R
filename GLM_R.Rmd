...
trainingdata1 <- read.csv("multi.csv")
trainingdata1 <- na.omit(trainingdata1)
trainingdata2 <- read.csv("subterraneus.csv")
trainingdata2 <- na.omit(trainingdata2)
testingdata1 <- read.csv("unknown1.csv")
...
```
```{r}
## creating boxplots again to check for the removal of outliers.
boxplot(trainingdata[,c('L', "H","W")],
horizontal=TRUE,
 names = c("Length", "Height","Width"))
```
